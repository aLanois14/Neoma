$(function () {
    ...
    if (len > 1) {
        $(".result").html('<b class="color-violet">' + len + '</b> porteurs correspondent à votre recherche');
    }
    else {
        $(".result").html('<b class="color-violet">' + len + '</b> porteur correspond à votre recherche');
    }
